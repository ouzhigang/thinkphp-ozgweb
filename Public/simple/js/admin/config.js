...
require.config({
    paths: {
		...
		"bootstrap": "http://localhost:8080/thinkphp-ozgweb/Public/simple/startbootstrap-sb-admin-2/bower_components/bootstrap/dist/js/bootstrap.min",
		"metisMenu": "http://localhost:8080/thinkphp-ozgweb/Public/simple/startbootstrap-sb-admin-2/bower_components/metisMenu/dist/metisMenu.min",		
		"sb_admin_2": "http://localhost:8080/thinkphp-ozgweb/Public/simple/startbootstrap-sb-admin-2/dist/js/sb-admin-2",
		"ckeditor": "http://localhost:8080/thinkphp-ozgweb/Public/simple/js/ckeditor/ckeditor",
		"ckeditor_jquery": "http://localhost:8080/thinkphp-ozgweb/Public/simple/js/ckeditor/adapters/jquery",
